...
struct circular_buffer_t {
    void *pBuffer; /**< pointer to data buffer array */
    size_t width; /**< Size of one element of the array */
    uint16_t head; /**< actual position of the head of the circular buffer */
    uint16_t tail; /**< actual position of the tail of the circular buffer */
    uint16_t size; /**< number of elements of the data buffer array */
};
...
/**
 * \brief Counts the actual number of elements in the buffer.
 *
 * \param [in] pcbh Pointer to a circular buffer struct instance.
 *
